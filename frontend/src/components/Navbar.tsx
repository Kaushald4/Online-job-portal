...
const Navbar = () => {
    ...
    const { handleSearchChange, searchType, search, handleSearchTypeChange } = useSearch();
        ...
        <div className="bg-[rgba(255,255,255,.06)] backdrop-blur shadow-sm h-[60px]">
            <div className="max-w-[1400px] mx-auto">
                <div className="flex justify-between flex-[.2] items-center h-[60px]">
                    <div>
                        <h1 className="h2 dark:text-white text-black">Job Portal</h1>
                    </div>
                    <div className="flex items-center flex-[.8]">
                        <div className="w-[500px] relative flex items-center">
                            ...
                            />
                            <div className="absolute right-4 cursor-pointer" onClick={search}>
                    ...
                    <div className="">
                        <div className="flex items-center gap-x-4 justify-end">
                            <Button onClick={toggleTheme} outline={true}>
                                {isDarkMode ? <IoSunnySharp /> : <IoMoonOutline />}
                            </Button>
                            <Avatar
